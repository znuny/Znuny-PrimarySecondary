...
/**
 * @namespace Core.Agent.TicketPrimarySecondary
 * @memberof Core.Agent
 * @author OTRS AG
 * @description
 *      This namespace contains special module functions for TicketPrimarySecondary.
 */
Core.Agent.TicketPrimarySecondary = (function (TargetNS) {
// ---
...
}(Core.Agent.TicketPrimarySecondary || {}));
// ---
